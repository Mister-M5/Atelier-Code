...
const app = Vue.createApp({
    ...
    data() {
        return {
            ...
            tile_classes: [
                ["border-2 border-neutral-500", "border-2 border-neutral-500", "border-2 border-neutral-500", "border-2 border-neutral-500", "border-2 border-neutral-500"],
                ["border-2 border-neutral-500", "border-2 border-neutral-500", "border-2 border-neutral-500", "border-2 border-neutral-500", "border-2 border-neutral-500"],
                ["border-2 border-neutral-500", "border-2 border-neutral-500", "border-2 border-neutral-500", "border-2 border-neutral-500", "border-2 border-neutral-500"],
                ["border-2 border-neutral-500", "border-2 border-neutral-500", "border-2 border-neutral-500", "border-2 border-neutral-500", "border-2 border-neutral-500"],
                ["border-2 border-neutral-500", "border-2 border-neutral-500", "border-2 border-neutral-500", "border-2 border-neutral-500", "border-2 border-neutral-500"],
    ...
    methods: {
        ...
        showTiles() {
                for (let i = 0; i < this.tiles.length; i++) {
                    this.tiles[i] = this.tiles[i].map(x => x)
        ...
        showNotification(message, duration = 3) {
            ...
            this.notification.timeout = setTimeout(() => {this.notification.show = false;}, duration * 1000);
